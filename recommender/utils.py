...
# 
# LABELS = {
#     MOOC_DATA: (TMP_DIR[MOOC_DATA] + '/train_label.pkl', TMP_DIR[MOOC_DATA] + '/test_label.pkl', TMP_DIR[MOOC_DATA] + '/validation_label.pkl'),
# }
# 
# # Entities
# USER = 'user'
...
# 
# PATH_PATTERN = {
#     #1: ((None, USER), (ENROLL, COURSE), (COURSE_SCATEGORY, SECOND_CATEGORY), (SCATEGORY_FCATEGORY, FIRST_CATEGORY), (SCATEGORY_FCATEGORY, SECOND_CATEGORY), (COURSE_SCATEGORY, COURSE)),
#     1: ((None, USER), (ENROLL, COURSE), (ENROLL, USER), (ENROLL, COURSE)),
#     2: ((None, USER), (ENROLL, COURSE), (COURSE_TEACHER, TEACHER), (COURSE_TEACHER, COURSE)),
#     3: ((None, USER), (ENROLL, COURSE), (COURSE_CONCEPT, CONCEPT), (COURSE_CONCEPT, COURSE)),
#     4: ((None, USER), (ENROLL, COURSE), (COURSE_SCHOOL, SCHOOL), (COURSE_SCHOOL, COURSE))
# }
...
def save_labels(path, labels, mode='train', use_wandb=False):
    if mode not in ['train', 'test', 'validation', 'train_target', 'test_target']:
        raise Exception('mode should be one of {train, test, validation, train_target, test_target}.')
...
def save_kg(path, kg, use_wandb=False):
    kg_file = path + '/kg.pkl'
...
def get_batch_entities(kg_args, use_user_relations=False, use_entity_relation=False):
