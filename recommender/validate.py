...
def validate(policy_file, epoch, args):
    ...
    avg_hit = evaluate_paths(args.dataset, path_file, train_labels, validation_labels, args.use_wandb, f'validation_result_epoch_{epoch}.txt', validation=True, sum_prob=args.sum_prob)
